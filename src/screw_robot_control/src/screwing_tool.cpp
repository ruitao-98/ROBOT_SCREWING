#include "screw_robot_control/jaka/screwing_tool.hpp"
#include<cmath>
#include <unistd.h>
#include <thread>
#include <chrono>
...
void endeffector::width_reduce(int distance, rclcpp::Publisher<robot_msgs::msg::CurrentPub>::SharedPtr pub,
...
void endeffector::width_increase(int distance, rclcpp::Publisher<robot_msgs::msg::CurrentPub>::SharedPtr pub,
						robot_msgs::msg::CurrentPub &msg,
...
int endeffector::width_reduce_full_for_handover(rclcpp::Publisher<robot_msgs::msg::CurrentPub>::SharedPtr pub,
												robot_msgs::msg::CurrentPub &msg,
												rclcpp::Publisher<robot_msgs::msg::WidthPub>::SharedPtr pub1,
												robot_msgs::msg::WidthPub &msg1){
    this->open_port();
...
int endeffector::screwing_s1(int speed, float circle, rclcpp::Publisher<robot_msgs::msg::CurrentPub>::SharedPtr pub,
	robot_msgs::msg::CurrentPub &msg)
{
	if (speed < 0) {
		speed = -speed;
...
int endeffector::screwing_s2(int speed, rclcpp::Publisher<robot_msgs::msg::CurrentPub>::SharedPtr pub,
	robot_msgs::msg::CurrentPub &msg)
{
	if (speed < 0) {
		speed = speed;
...
void endeffector::unscrewing_s1(int speed_1, int speed_2) {
	if (speed_1 < 0) {
		speed_1 = -speed_1;
	}
	else {
