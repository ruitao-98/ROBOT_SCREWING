...
#ifndef ROBOT_MSGS__SRV__DETAIL__START_POSE__FUNCTIONS_H_
#define ROBOT_MSGS__SRV__DETAIL__START_POSE__FUNCTIONS_H_
...
/// Initialize srv/StartPose message.
/**
...
/// Finalize srv/StartPose message.
/**
...
/// Create srv/StartPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__StartPose_Request__init().
...
/// Destroy srv/StartPose message.
/**
 * It calls
 * robot_msgs__srv__StartPose_Request__fini()
...
/// Check for srv/StartPose message equality.
/**
...
/// Initialize array of srv/StartPose messages.
/**
...
/// Finalize array of srv/StartPose messages.
/**
 * It calls
 * robot_msgs__srv__StartPose_Request__fini()
...
/// Create array of srv/StartPose messages.
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__StartPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StartPose messages.
/**
 * It calls
 * robot_msgs__srv__StartPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StartPose message array equality.
/**
...
/// Copy an array of srv/StartPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__StartPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__StartPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__StartPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__StartPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_MSGS__SRV__DETAIL__START_POSE__FUNCTIONS_H_
