...
#ifndef ROBOT_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
#define ROBOT_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * robot_msgs__msg__ControlCommand__init().
...
/**
 * It calls
 * robot_msgs__msg__ControlCommand__fini()
 ...
 * robot_msgs__msg__ControlCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_msgs__msg__ControlCommand__Sequence__fini()
 * on the array,
...
#endif  // ROBOT_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
