...
from mj_sim.pose_mpc_optimizer import Mpc_Opti, predict_next_state 
...
class Data_Recorder(Node):
    def __init__(self, simulation_disturbances):
        ...
        self.rec_dict, self.rec_file = self.get_record_file_and_dir(self.blank_recording_dict, recording_options, simulation_options, overwrite=True)
    ...
    def matrices_to_axis_angle(self, _eef_rotm, _eef_rotm_d):
        # 计算旋转误差
        e_rotm = _eef_rotm @ _eef_rotm_d.T
