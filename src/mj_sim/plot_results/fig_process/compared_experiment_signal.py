...
import compared_experiment_statistics as statis
...
def plot_3d_metrics(csv_path0, csv_path1, csv_path2, csv_path3):
    """
    ...
    ax1.plot(force_vector_x0, linewidth = 2, color='r', label = 'MPC-GP')
    ax1.plot(force_vector_x1, linewidth=2, color='orange', label = 'MPC')
    ax1.plot(force_vector_x2, linewidth=2, color='b', label = 'LAC')
    ax1.plot(force_vector_x3, linewidth=2, color='g', label = 'SAC')
    # ax1.legend(loc='upper right')
    # ax1.set_xticks(param_values)  # Set x-axis ticks to data values only
    ax1.set_ylabel(r'$F_x$ [$\rm N$]')
    plt.grid(True)

    ax2 = fig.add_subplot(212)
    ax2.plot(force_vector_y0, linewidth=2, color='r', label = 'MPC-GP')
    ax2.plot(force_vector_y1, linewidth=2, color='orange', label = 'MPC')
    ax2.plot(force_vector_y2, linewidth=2, color='b', label = 'LAC')
    ax2.plot(force_vector_y3, linewidth=2, color='g', label = 'SAC')
    # ax2.legend()
    # ax1.set_xticks(param_values)  # Set x-axis ticks to data values only
    ax2.set_ylabel(r'$F_y$ [$\rm N$]')
    plt.grid(True)

    plt.savefig('figure/compared_force_a.svg', dpi=300, format="svg", bbox_inches='tight')
    plt.show()

    fig = plt.figure(figsize=(12, 8))
    ax3 = fig.add_subplot(211)
    ax3.plot(pos_vector_x0, linewidth=2, color='r', label = 'MPC-GP')
    ax3.plot(pos_vector_x1, linewidth=2, color='orange', label = 'MPC')
    ax3.plot(pos_vector_x2, linewidth=2, color='b', label = 'LAC')
    ax3.plot(pos_vector_x3, linewidth=2, color='g', label = 'SAC')
    ax3.plot(refstatus0_x0, linewidth=2, color='black', linestyle='--', label='REF')

    # ax1.set_xticks(param_values)  # Set x-axis ticks to data values only
    ax3.set_ylabel(r'$x$ [$\rm m$]')
    plt.grid(True)

    ax4 = fig.add_subplot(212)
    ax4.plot(pos_vector_y0, linewidth=2, color='r', label = 'MPC-GP')
    ax4.plot(pos_vector_y1, linewidth=2, color='orange', label = 'MPC')
    ax4.plot(pos_vector_y2, linewidth=2, color='b', label = 'LAC')
    ax4.plot(pos_vector_y3, linewidth=2, color='g', label = 'SAC')
    ax4.plot(refstatus0_y0, linewidth=2, color='black', linestyle='--', label='REF')
    # ax4.legend(loc='upper left')
    # ax4.legend(loc='upper right')
    # ax1.set_xticks(param_values)  # Set x-axis ticks to data values only
    ax4.set_ylabel(r'$y$ [$\rm m$]')
    plt.grid(True)

    # Adjust layout and display
    plt.tight_layout()
    plt.grid(True)
    plt.savefig('figure/compared_pos_a.svg', dpi=300, format="svg", bbox_inches='tight')
    plt.show()

    statis.plot_statistics(csv_path0, csv_path1, csv_path2, csv_path3)


if __name__ == "__main__":
    # csv_path0 = "/home/yanji/rosbag_record/compared_experiment/para_a_0_1"
    # csv_path1 = "/home/yanji/rosbag_record/compared_experiment/para_a_1_9"  # Adjust path if needed
    # csv_path2 = "/home/yanji/rosbag_record/compared_experiment/para_a_2_1"
    # csv_path3 = "/home/yanji/rosbag_record/compared_experiment/copy/para_a_3"

    csv_path0 = "/home/yanji/rosbag_record/compared_experiment/para_b_0_3"
    csv_path1 = "/home/yanji/rosbag_record/compared_experiment/para_b_1_15"  # Adjust path if needed
    csv_path2 = "/home/yanji/rosbag_record/compared_experiment/para_b_2_2"
    csv_path3 = "/home/yanji/rosbag_record/compared_experiment/copy/para_b_3"

    plot_3d_metrics(csv_path0, csv_path1, csv_path2, csv_path3)