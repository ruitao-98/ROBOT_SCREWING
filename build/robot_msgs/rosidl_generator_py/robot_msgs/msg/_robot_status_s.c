...
bool robot_msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // ft_vector
    PyObject * field = PyObject_GetAttrString(_pymsg, "ft_vector");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 6;
      double * dest = ros_message->ft_vector;
  ...
  {  // pos_vector
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 3;
      double * dest = ros_message->pos_vector;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
  ...
  {  // rotation_matrix
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 9;
      double * dest = ros_message->rotation_matrix;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
  ...
  {  // vel_vector
    PyObject * field = PyObject_GetAttrString(_pymsg, "vel_vector");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 6;
      double * dest = ros_message->vel_vector;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * robot_msgs__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // ft_vector
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "ft_vector");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->ft_vector[0]);
  ...
  {  // pos_vector
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->pos_vector[0]);
  ...
  {  // rotation_matrix
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->rotation_matrix[0]);
    memcpy(dst, src, 9 * sizeof(double));
    Py_DECREF(field);
  }
  {  // vel_vector
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "vel_vector");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->vel_vector[0]);
    memcpy(dst, src, 6 * sizeof(double));
    Py_DECREF(field);
  }
